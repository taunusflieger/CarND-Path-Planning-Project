...
std::vector<int>
Prediction::getNearbyCars(std::vector<Vehicle> const &otherCars) {
  ...
  return {nearby_front_[0], nearby_back_[0],  nearby_front_[1],
          nearby_back_[1],  nearby_front_[2], nearby_back_[2]};
}
